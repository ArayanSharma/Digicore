...
const PAGE_SLUG = "travel";

const initialData = {
  hero: {
    title: "Best SEO Agency for Travel Industry | Digicore Inc.",
  ...
  seoAgency: {
    heading: "Why Digital Marketing is Important for Travel Industry",
    description: "Digicore Inc. is a 360 digital marketing agency in Delhi that is dedicated to helping brands develop, engage, and lead.",
    problemTitle: "The Problem",
    problemText: "Travel seekers today begin their journeys online. Without a strong digital presence, travel brands risk being invisible to millions of potential customers actively searching for their next adventure.",
    solutionTitle: "The Solution",
    solutionText: "From Google, Instagram and YouTube to marketplaces like Amazon and Flipkart, travelers are searching everywhere, and that's why it is important for your travel brand to be visible everywhere.",
    rightText1:
  ...
  discover: {
    heading: "Travel SEO Services",
    description: "With the customized level of optimization, scope of improving the online visibility, and the efforts required to cater to industry-specific objectives, Digicore Inc. plans SEO services. From boosting the conversion and clickthrough rates to driving potential customers through organic traffic, our Travel SEO services deliver measurable results backed by detailed reports.",
  },
  services: [
    { id: uid(), icon: "", title: "Enterprise SEO", description: "Offering tailored SEO strategies to help enterprises boost their online presence, attract high-quality, relevant traffic and leave a lasting impression." },
    { id: uid(), icon: "", title: "Global SEO", description: "Helping brands rank higher in search engines with our Global SEO services designed for expanding reach and driving targeted traffic worldwide." },
    { id: uid(), icon: "", title: "E-commerce SEO", description: "Helping online stores maximize visibility, attract high-intent shoppers and drive sales through search engines with our tailored E-Commerce SEO solutions." },
    { id: uid(), icon: "", title: "National SEO", description: "Strengthening brands with robust data-driven strategies designed to boost their website's visibility in national search results and drive high-quality traffic." },
    { id: uid(), icon: "", title: "AI SEO", description: "From predictive keyword research to AI-powered insights for links and technical SEO, we create strategies that boost rankings and drive real engagement." },
    { id: uid(), icon: "", title: "GEO SEO", description: "Achieve maximum visibility in specific geographic locations with our tailored GEO SEO that intelligently combines advanced local and global SEO strategies." },
    { id: uid(), icon: "", title: "AEO SEO", description: "We can optimize your content for answer engines and AI-driven search results and help you stay ahead in the evolving digital world." },
    { id: uid(), icon: "", title: "TECHNICAL SEO", description: "Delivering high-quality technical SEO to improve site speed, mobile performance and site architecture to help brands stand out in search visibility." },
    { id: uid(), icon: "", title: "Content Marketing Services", description: "Helping brands tell their story in a unique way and forge deeper connections with audiences through our high-quality content marketing services." },
  ],
  whyChoose: {
    heading: "Scale Your Online Presence with High-Performance Travel SEO.",
    backgroundImage: "",
  ...
  impact: {
    ...
    timeline: [
      ...
      { id: uid(), title: "Google Premier Partner", description: "We are a Google Premier Partner since 2017. This means we're one of Top 50 PPC Companies in India from 4000 odd Digital Marketing agencies that have partnered with Google." },
  ...
  video: {
    title: "Travel SEO drives bookings and organic visibility for travel brands.",
    url: "https://www.youtube.com/embed/RugY9uuIJhY",
  },
  dominate: {
    heading: "How We Grow Your Travel Business & Bookings",
  ...
  whyBusiness: {
    ...
    description: "Digicore Inc., the leading digital marketing agency in Delhi extends assistance and 360 degree digital marketing strategies to all sized businesses. We have mastered industry wise excellence to become the stellar company committed towards brand building. We have adopted effective, innovative and relevant approach for implementing digital marketing plans. With problem solving and result-driven methods, we help clients attain their goals. Here are some of the key features of our services which make us the trusted digital marketing company in Delhi, India.",
    image: "",
    features: [
      { id: uid(), text: "Provide your business with a dedicated account manager and team" },
      { id: uid(), text: "Guidance for the betterment of travel startups!" },
      ...
      { id: uid(), text: "Expert guidance for strengthening brand presence" },
      { id: uid(), text: "Increase search friendliness of your travel business with SEO services!" },
    ],
  },
  faqHeading: "FAQ",
  faq: [
    { id: uid(), question: "How long will it take for my travel website to start ranking on Google?", answer: "The time a website takes to rank on Google varies between 3 – 6 months. The major components that affect your website ranking and timeline include your industry competition, SEO efforts and content quality." },
  ],
};

export default function ADTravel() {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      setStatus("saved");
      showToast("Travel page saved successfully");
    } catch (err) {
      console.error(err);
      setStatus("error");
  ...
  return (
    <div className="min-h-screen bg-bg-card py-8 px-4 md:px-8 lg:px-10 flex flex-col gap-6">
        ...
        <PageHeader title="Travel Page - Admin" description="Edit all Travel page sections from the admin panel." status={status} />
      <form onSubmit={handleSave} className="w-full">
        ...
        <Section title="7. Services Cards" open={openSection === "services"} onToggle={() => toggle("services")}>
          <LeadForm
            ...
            onChange={(v) => setPageData((current) => ({ ...current, services: v }))}
            fields={[
        ...
        <Section title="9. Impact / Timeline Section" open={openSection === "impact"} onToggle={() => toggle("impact")}>
          ...
          <LeadForm
            ...
            onChange={(v) => updateSection("impact", "timeline", v)}
            fields={[
              { name: "title", label: "Title", type: "text", required: true },
        ...
        <Section title="13. How We Grow Section" open={openSection === "dominate"} onToggle={() => toggle("dominate")}>
          ...
          <LeadForm
            ...
            onChange={(v) => updateSection("dominate", "cards", v)}
            fields={[
              { name: "icon", label: "Icon", type: "image" },
              { name: "title", label: "Title", type: "text", required: true },
        ...
        <Section title="14. Why Business Section" open={openSection === "whyBusiness"} onToggle={() => toggle("whyBusiness")}>
          ...
          <LeadForm
            ...
            onChange={(v) => updateSection("whyBusiness", "features", v)}
        ...
        <Section title="15. FAQ Section" open={openSection === "faq"} onToggle={() => toggle("faq")}>
          ...
          <LeadForm
            ...
            addLabel="Add FAQ"
            items={pageData.faq}
            onChange={(v) => setPageData((current) => ({ ...current, faq: v }))}
            fields={[
