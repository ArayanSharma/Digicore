...
const Hospitality = () => {
  const { content: c } = usePageContent("hospitality");
  const hero = c?.hero;
  const about = c?.about;
  ...
  return (
    <>
      ...
      <Banner
        ...
        title={hero?.title || "Hospitality SEO Agency That Drives Traffic, Trust, and Conversions for Hotel & Restaurant"}
      ...
      <section className="w-full py-[100px] px-5 bg-[#f4f4f5] border-b border-[#e5e7eb]">
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col gap-6 bg-white rounded-2xl border border-[#e5e7eb] p-8 shadow-[0_4px_15px_rgba(0,0,0,0.03)]">
              <p className="text-[16px] leading-[1.8] text-[#4b5563]">
      ...
      <section className="w-full py-[100px] px-5 bg-[#f4f4f5] text-center border-b border-[#e5e7eb]">
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <h2 className="text-[48px] max-[993px]:text-[38px] max-[769px]:text-[30px] leading-[1.1] text-[#1c1c1e] mb-[25px] font-heading font-extrabold">
            {discover?.heading || "Hospitality SEO Services"}
          </h2>
      ...
      <div className="w-full bg-white text-center py-[60px] px-5 pb-20 max-[769px]:p-[50px_15px]">
        <div className="w-[60px] h-[4px] bg-[#e31e24] mx-auto mb-[25px] rounded-[10px] max-[769px]:w-[50px] max-[769px]:mb-[20px]"></div>

        <h1 className="font-heading font-extrabold text-[44px] leading-[1.2] max-[993px]:text-[36px] max-[769px]:text-[28px] text-[#2b2b2e] mb-10 max-w-[1000px] mx-auto">
        ...
        <section className="flex justify-center items-center">
          <div className="w-full max-w-[900px] rounded-[30px] overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.12)] mx-auto">
            <iframe
