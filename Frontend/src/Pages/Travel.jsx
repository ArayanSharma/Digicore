...
const Travel = () => {
  const { content: c } = usePageContent("travel");
  const hero = c?.hero;
  const about = c?.about;
  ...
  return (
    <>
      ...
      <Banner
        ...
        title={hero?.title || "Drive Traffic, Leads & Revenue with Expert Digital Marketing Services"}
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row justify-between items-center gap-[60px] lg:gap-[40px] px-5">
          <div className="flex-1">
            ...
            <p className="font-normal text-[16px] leading-[1.8] text-[#4b5563] m-0">
              {visibility?.paragraph1 || "AI has brought a lot of change in the way people search, discover, and buy. However, with it, the need to strengthen visibility has increased. Today, ranking should not be only about Google; it should be about visibility wherever audiences are looking—like Google, Instagram, YouTube, LinkedIn, marketplaces, or even AI-generated results."}
              <br /><br />
              {visibility?.paragraph2 || "From Google, Instagram and YouTube to markeplaces like Amazon and Flipkart, consumers are searching everywhere, and that's why it is important for your brand to be visible everywhere."}
            </p>
      ...
      <section className="w-full py-[100px] px-5 bg-white border-b border-[#e5e7eb]">
        <div className="max-w-[1200px] mx-auto text-center px-5 mb-[60px]">
          <div className="w-[60px] h-[4px] bg-[#e31e24] mx-auto mb-[25px] rounded-[10px] max-[769px]:w-[50px] max-[769px]:mb-[20px]"></div>
        ...
        <div className="max-w-[1200px] mx-auto px-5 grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="flex flex-col gap-6">
            <div>
              <h3 className="text-[22px] font-heading font-bold text-[#2b2b2e] mb-[10px]">{seoAgency?.problemTitle || "The Problem"}</h3>
            ...
            <div>
              <h3 className="text-[22px] font-heading font-bold text-[#2b2b2e] mb-[10px]">{seoAgency?.solutionTitle || "The Solution"}</h3>
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-[1000px] mx-auto">
          ...
          <div className="flex justify-center items-center gap-5 max-[769px]:flex-col">
            <a href={whyChoose?.button1?.link || "#"} className="flex items-center justify-center gap-[10px] bg-white hover:bg-[#f0fdf4] hover:scale-[1.03] transition-all duration-300 text-[#22c55e] h-12 px-7 rounded-lg text-base font-bold no-underline shadow-[0_4px_15px_rgba(34,197,94,0.16)] border border-[#22c55e]/25">
              <img
            ...
            <a href={whyChoose?.button2?.link || "#"} className="flex items-center justify-center gap-[10px] bg-transparent hover:bg-white/10 hover:scale-[1.03] transition-all duration-300 text-white h-12 px-7 rounded-lg text-base font-bold no-underline border border-white">
      ...
      <section className="w-full py-[100px] px-5 max-[769px]:py-[60px] bg-white text-center border-b border-[#e5e7eb]">
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <h1 className="text-[42px] max-[993px]:text-[34px] max-[769px]:text-[28px] leading-[1.3] text-[#1c1c1e] font-heading font-extrabold mb-[50px] max-[769px]:mb-[35px]">
          ...
          <div className="flex justify-center items-center">
            <div className="w-full max-w-[900px] rounded-[30px] max-[769px]:rounded-[20px] overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.12)]">
              <iframe
        ...
        <div className="flex justify-center gap-10 flex-wrap mt-[30px]">
          {displayDominateCards.map((item, index) => (
            ...
            >
              ...
              <h3 className="relative z-[2] text-[18px] max-[769px]:text-[15px] font-heading font-bold text-[#2b2b2e] leading-tight m-0 transition-colors duration-300 group-hover:text-white group-hover:mb-[10px]">
                {item.title}
              </h3>

              <p className="relative z-[2] mt-0 text-[12px] leading-[1.5] text-white opacity-0 max-h-0 overflow-hidden transition-all duration-300 group-hover:opacity-90 group-hover:max-h-[120px]">
                {item.desc}
              </p>
            </div>
          ))}
