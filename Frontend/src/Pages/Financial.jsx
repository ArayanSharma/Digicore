...
const Financial = () => {
  const { content: c } = usePageContent("financial-professional");
  const hero = c?.hero;
  const about = c?.about;
  ...
  return (
    <>
      ...
      <div className="max-w-[1200px] mx-auto text-center px-5 pt-[100px]">
        <div className="w-[60px] h-[4px] bg-[#e31e24] mx-auto mb-[25px] rounded-[10px] max-[769px]:w-[50px] max-[769px]:mb-[20px]"></div>
        <h1 className="font-heading font-extrabold text-[36px] leading-[1.2] max-[993px]:text-[30px] max-[769px]:text-[26px] text-[#2b2b2e] mb-10">
        ...
        <div className="max-w-[900px] mx-auto rounded-2xl overflow-hidden shadow-[0_15px_35px_rgba(0,0,0,0.08)] border border-[#e5e7eb] aspect-video">
          <iframe
