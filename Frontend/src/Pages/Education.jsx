...
const Education = () => {
  ...
  const displayCaseStudies = c?.caseStudies?.length
    ? c.caseStudies.map((cs) => ({
      ...cs,
      image: resolveImage(cs.image),
      descriptions: Array.isArray(cs.descriptions)
        ? cs.descriptions
        : cs.descriptions
          ? [cs.descriptions]
          : [],
  ...
  const displayIndustries = industriesSection?.items?.length
    ? industriesSection.items.map((i) => ({ ...i, image: resolveImage(i.image) }))
    : industries;
  ...
  const displayFaq = faq?.items?.length ? faq.items : faqData;
  const displayPoints = whyChoose?.points?.length
    ? whyChoose.points
    : [
      { text: "Provide your business with a dedicated account manager and team" },
      { text: "Guidance for the betterment of startup!" },
      { text: "Deliver transparent bi-monthly reports to your team" },
      { text: "Build result-oriented customized strategies" },
      { text: "Save time and money by availing our services" },
      { text: "Get a comprehensive solution for 360° digital marketing strategy" },
      { text: "Expert guidance for strengthening brand presence of a startup!" },
      { text: "Increase search friendliness of your business with SEO services!" },
    ];
  ...
  return (
    <>
      ...
      <Banner
        ...
        title={hero?.title || "EDUCATION SEO AGENCY FOR Universities, Colleges & Educational Institutes"}
        description={hero?.description || "To succeed in business, you first need to succeed in search results. Our digital marketing services connect you with your customers’ journey from end to end – from discovery to retention."}
      ...
      <section className="w-full py-[100px] px-5 max-[769px]:py-[60px] bg-white border-b border-[#e5e7eb]">
        <div className="max-w-[1300px] mx-auto text-center pt-[60px] px-5 pb-20 max-[769px]:p-[50px_15px]">
          <h1 className="font-heading font-extrabold text-[44px] leading-[1.2] max-[993px]:text-[36px] max-[769px]:text-[28px] text-[#2b2b2e] mb-6">
            {about?.heading || "Best Healthcare SEO Company"}
          </h1>
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row justify-between items-center gap-[60px] lg:gap-[40px] px-5">
          <div className="flex-1">
            ...
            <p className="font-normal text-[16px] leading-[1.8] text-[#4b5563] m-0">
              {visibility?.description || (<>AI has brought a lot of change in the way people search, discover, and buy. However, with it, the need to strengthen visibility has increased. Today, ranking should not be only about Google; it should be about visibility wherever audiences are looking—like Google, Instagram, YouTube, LinkedIn, marketplaces, or even AI-generated results.
                <br /><br />
      ...
      <section className="w-full py-[100px] px-5 max-[769px]:py-[60px] bg-[#f4f4f5] border-b border-[#e5e7eb]">
        <div className="max-w-[1150px] mx-auto">
          <div className="text-center mb-[50px] max-[769px]:mb-[35px]">
            <div className="w-[55px] h-[4px] bg-[#e31e24] mx-auto mb-[18px] rounded-[10px] max-[769px]:w-[45px]"></div>
            ...
            <h2 className="text-[42px] max-[993px]:text-[34px] max-[769px]:text-[26px] text-[#1c1c1e] font-heading font-extrabold mb-[30px] leading-[1.2]">
              {seoAgencySection?.heading || "Why Do I Need an Healthcare SEO Agency"}
            </h2>
            <p className="text-[17px] leading-[1.8] text-[#4b5563] max-w-[1000px] mx-auto m-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-[70px]">
            <div>
              <h3 className="text-[28px] max-[769px]:text-[22px] font-heading font-bold text-[#e31e24] mb-4">
                {seoAgencySection?.problemTitle || "The Problem"}
              </h3>

              <p className="text-[16px] leading-[1.8] text-[#4b5563] mb-6">
                {seoAgencySection?.problemText || "AI has brought a lot of change in the way people search, discover, and buy. However, with it, the need to strengthen visibility has increased."}
              </p>

              <h3 className="text-[28px] max-[769px]:text-[22px] font-heading font-bold text-[#e31e24] mb-4">
                {seoAgencySection?.solutionTitle || "The Solution"}
              </h3>

              <p className="text-[16px] leading-[1.8] text-[#4b5563]">
                {seoAgencySection?.solutionText || "From Google, Instagram and YouTube to markeplaces like Amazon and Flipkart, consumers are searching everywhere, and that's why it is important for your brand to be visible everywhere."}
              </p>
            </div>

            <div className="pt-4">
              <p className="text-[16px] leading-[1.9] text-[#4b5563] mb-6">
              ...
              <p className="text-[16px] leading-[1.9] text-[#4b5563]">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(28, 28, 30, 0.9), rgba(28, 28, 30, 0.95)), url(${ctaStrip?.backgroundImage ? resolveImage(ctaStrip.backgroundImage) : bgIcon})`,
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-[1000px] mx-auto">
          <h1 className="text-white text-[42px] max-[769px]:text-[30px] font-heading font-extrabold leading-[1.2] mb-[40px] uppercase">
            {ctaStrip?.heading || "Scale Your Online Store with High-Performance E-commerce SEO."}
          </h1>

          <div className="flex justify-center items-center gap-5 max-[769px]:flex-col">
            <a
              href={ctaStrip?.whatsappLink || "#"}
            ...
            >
              ...
              />
              {ctaStrip?.whatsappText || "+91 98188 88064"}
            </a>

            <a
              href={ctaStrip?.secondaryBtnLink || "#"}
            ...
            >
              {ctaStrip?.secondaryBtnText || "REQUEST A CALLBACK"}
            </a>
          </div>
        </div>
      </section>
            ...
            <div className="relative border-l border-[#e5e7eb] pl-6 ml-3">
              {(impactSection?.timeline?.length ? impactSection.timeline : [
                ...
                },
                {
                  ...
                  description: "We are a Google Premier Partner since 2017. This means we’re are one of Top 50 PPC Companies in India from 4000 odd Digital Marketing agencies that have partnered with Google.",
                },
                {
                  title: "Search engine optimization",
                  description: "Our SEO professionals have decades of experience providing results to clients and sound knowledge of the latest search engine optimization trends.",
                },
              ]).map((item, index) => (
      ...
      <section className="w-full py-[100px] px-5 max-[769px]:py-[60px] bg-white text-center border-b border-[#e5e7eb]">
        <div className="max-w-[1200px] mx-auto px-5">
          <div className="w-[60px] h-[4px] bg-[#e31e24] mx-auto mb-[25px] rounded-[10px] max-[769px]:w-[50px] max-[769px]:mb-[20px]"></div>

          <h1 className="text-[42px] max-[993px]:text-[34px] max-[769px]:text-[26px] font-heading font-extrabold text-[#1c1c1e] leading-[1.3] mb-[50px] max-w-[1000px] mx-auto">
            {videoSection?.title || "SEO is not just about ranking on Google — it’s about connecting your brand across every platform where your customers search."}
          </h1>
          ...
          <div className="flex justify-center items-center">
            <div className="w-full max-w-[900px] rounded-[30px] overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.12)]">
              <iframe
                ...
                title={videoSection?.title || " Digicore Inc Video"}
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
                className="w-full h-[510px] max-[992px]:h-[420px] max-[769px]:h-[250px] border-0 block"
              ></iframe>
            </div>
          </div>
        </div>
      ...
      <section className="py-[100px] px-[6%] bg-[#f4f4f5] text-center border-b border-[#e5e7eb]">
        <div className="max-w-[1200px] mx-auto px-5">
          <h2 className="text-[42px] max-[769px]:text-[30px] text-[#1c1c1e] font-heading font-extrabold mb-[15px]">
            {dominate?.heading || "DOMINATE YOUR INDUSTRY WITH US"}
          </h2>
        ...
        <div className="max-w-[1200px] mx-auto px-5">
          <div className="text-center mb-[60px]">
            ...
            <h2 className="text-[42px] max-[769px]:text-[30px] font-heading font-extrabold text-[#1c1c1e] mb-[20px]">
              {whyChoose?.heading || "Why business choose Digicore Inc."}
            </h2>
          ...
          <div className="flex items-center gap-[60px] max-[993px]:flex-col">
            <div className="flex-1 w-full">
              <ul className="list-none p-0 flex flex-col gap-4">
                {displayPoints.map((point, index) => (
                  <li key={point.id || index} className="text-[16px] leading-[1.6] bg-white p-5 rounded-xl shadow-[0_4px_15px_rgba(0,0,0,0.03)] border border-[#e5e7eb]/60 transition-all duration-300 hover:translate-x-[8px] flex items-start">
            ...
            <div className="flex-1 text-center w-full">
              <img
                src={whyChoose?.image ? resolveImage(whyChoose.image) : graphImg}
                alt="Graph"
      ...
      <section className="py-[100px] px-5 bg-white border-b border-[#e5e7eb]">
        <div className="text-center mb-[50px]">
          <h2 className="text-[42px] font-heading font-extrabold text-[#1c1c1e] mb-[10px]">{faq?.heading || "PPC AGENCY DELHI FAQS"}</h2>
        ...
        <div className="max-w-[950px] mx-auto flex flex-col gap-4">
          {displayFaq.map((item, index) => (
            ...
            >
              ...
              >
                <span className="text-[16px] font-heading font-bold text-[#2b2b2e] leading-[1.5] max-w-[90%] group-hover:text-[#e31e24]">{item.question}</span>
              ...
              >
                <p className="text-[15px] text-[#4b5563] leading-[1.7] pt-0 px-6 pb-6 border-t border-[#e5e7eb]/40">{item.answer}</p>
              </div>
            </div>
          ))}
        </div>
