...
const Youtube = () => {
  ...
  const displayTimelineItems = Array.isArray(timelineSection?.items)
  ...
  const displayPoints = Array.isArray(whyChooseDigicoreSection?.points)
  ...
  return (
    <>
      ...
      {visibilitySection && (visibilitySection.title || visibilitySection.description || visibilitySection.videoUrl) && (
          ...
          <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row justify-between items-center gap-[60px] lg:gap-[40px] px-5">
            ...
            <div className="flex-1 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[550px] rounded-2xl overflow-hidden shadow-[0_15px_35px_rgba(0,0,0,0.06)] border border-[#e5e7eb]">
                <video
                  ref={videoRef}
                  src={visibilitySection.videoUrl ? resolveImage(visibilitySection.videoUrl) : v1}
